...
; affichage d'un registre en base 16 (hexadécimal)
; manipulations des sous registres.
...
main:
    ...
    push eax
    call  afficherReg16
    afficherLib "Affichage valeur maxi 4 bits"
    mov eax,0xF
    push eax
    call  afficherReg16
    push eax
    call afficherBinaire
    afficherLib "Affichage valeur maxi 16 bits"
    mov eax,0
    mov ax,0xFFFF
    push eax
    call  afficherReg16
    push eax
    call afficherBinaire
    afficherLib "Affichage valeur maxi 8 bits"
    mov eax,0
    mov al,0xFF
    push eax
    call  afficherReg16
    push eax
    call afficherBinaire
    afficherLib "Affichage valeur maxi 8 bits partie haute"
    mov eax,0
    mov ah,0xFF
    push eax
    call  afficherReg16
    push eax
    call afficherBinaire
    afficherLib "Affichage valeur maxi 4 bits partie basse ebx"
    mov bl,0xF
    push ebx 
    call  afficherReg16
    afficherLib "Affichage valeur maxi 16 bits partie basse edi"
    mov di,0xFFFF
    push edi 
    call  afficherReg16
    afficherLib "Affichage adresse pile"
    push esp 
    call  afficherReg16
    afficherLib "Affichage adresse main"
    push main
    call  afficherReg16
