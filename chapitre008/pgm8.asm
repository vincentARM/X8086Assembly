...
; affichage d'un registre en base 2 (binaire)
; instructions de manipulation des bits
...
main:
    ...
    push eax
    call afficherBinaire
    afficherLib "2puissance 32 -1"
    mov eax,(1<<32) - 1
    push eax
    call afficherBinaire
    afficherLib "Instruction and"
    mov eax,0b0011
    mov ebx,0b0101
    and eax,ebx
    push eax
    call afficherBinaire
    afficherLib "Instruction or"
    mov eax,0b0011
    mov ebx,0b0101
    or eax,ebx
    push eax
    call afficherBinaire
    afficherLib "Instruction xor"
    mov eax,0b0011
    mov ebx,0b0101
    xor eax,ebx
    push eax
    call afficherBinaire
    afficherLib "Instruction not"
    mov eax,0b0011
    ;mov ebx,0b0101
    not eax
    push eax
    call afficherBinaire
    ; instruction xor sur le même registre
    afficherLib "Instruction xor sur même registre"
    mov eax,0b0011
    xor eax,eax
    push eax
    call afficherBinaire
