...
O_CREAT   equ  100       ; creation si inexistant
O_TRUNC   equ  1000      ; tronqué à 0
O_EXCL    equ  200       ; erreur si le fichier existe déjà
...
main:
    ...
    mov eax,CREAT             ; création du fichier
    mov ebx,szNomFic          ; nom du fichier
    mov ecx,0o664             ; code en octal pour attribuer les droits au fichier
    int 0x80
    cmp eax,0                 ; erreur ?
    jle erreur
